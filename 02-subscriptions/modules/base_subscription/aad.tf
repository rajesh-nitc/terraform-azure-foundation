...
# So that web-e-auth-cicd (as part of github actions) is able to update the redirect URI in aad app
# web-e-auth-cicd workflow is not able to update redirect uri with "Application Developer" role
